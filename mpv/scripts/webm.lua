...
do
  ...
  _class_0 = setmetatable({
    __init = function(self)
      self.displayName = "UT Video yuv420p"
      self.supportsTwopass = false
      self.videoCodec = "utvideo"
      self.audioCodec = "pcm_s16le"
      self.outputExtension = "avi"
      self.acceptsBitrate = false
    end,
...
do
  ...
  _class_0 = setmetatable({
    __init = function(self)
      self.displayName = "UT Video yuv422p"
      self.supportsTwopass = false
      self.videoCodec = "utvideo"
      self.audioCodec = "pcm_s16le"
      self.outputExtension = "avi"
...
do
  ...
  _class_0 = setmetatable({
    __init = function(self)
      self.displayName = "UT Video yuv444p"
      self.supportsTwopass = false
      self.videoCodec = "utvideo"
      self.audioCodec = "pcm_s16le"
      self.outputExtension = "avi"
...
do
  ...
  _class_0 = setmetatable({
    __init = function(self)
      self.displayName = "WebM (VP9_QSV)"
      self.supportsTwopass = false
      self.videoCodec = "vp9_qsv"
      self.audioCodec = "libopus"
      self.outputExtension = "webm"
      self.acceptsBitrate = false
    end,
...
do
  ...
  _class_0 = setmetatable({
    __init = function(self)
      self.displayName = "AVC-slow (x264/AAC)"
      self.supportsTwopass = true
      self.videoCodec = "libx264"
      self.audioCodec = "aac"
      self.outputExtension = "mp4"
...
do
  ...
  _class_0 = setmetatable({
    __init = function(self)
      self.displayName = "AVC-veryslow (x264/AAC)"
      self.supportsTwopass = true
      self.videoCodec = "libx264"
      self.audioCodec = "aac"
      self.outputExtension = "mp4"
...
do
  ...
  _class_0 = setmetatable({
    __init = function(self)
      self.displayName = "AVC (h264-QSV/AAC)"
      self.supportsTwopass = false
...
do
  ...
  _class_0 = setmetatable({
    __init = function(self)
      self.displayName = "AVC (h264-QSV/OPUS)"
      self.supportsTwopass = false
      self.videoCodec = "h264_qsv"
      self.audioCodec = "libopus"
      self.outputExtension = "mp4"
...
do
  ...
  _class_0 = setmetatable({
    __init = function(self)
      self.displayName = "AV1_QSV"
      self.supportsTwopass = false
      self.videoCodec = "av1_qsv"
      self.audioCodec = "libopus"
      self.outputExtension = "mp4"
      self.acceptsBitrate = false
    end,
...
do
  ...
  _class_0 = setmetatable({
    __init = function(self)
      self.displayName = "HEVC (HEVC-QSV/AAC)"
      self.supportsTwopass = true
      self.videoCodec = "hevc_nvenc"
      self.audioCodec = "aac"
      self.outputExtension = "mp4"
...
do
  ...
  _class_0 = setmetatable({
    __init = function(self)
      self.displayName = "AAC (.m4a)"
      self.supportsTwopass = false
      self.videoCodec = ""
      self.audioCodec = "aac"
      self.outputExtension = "m4a"
      self.acceptsBitrate = true
    end,
    __base = _base_0,
    __name = "AAC",
